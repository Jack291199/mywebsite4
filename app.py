...
if selected == "Giới Thiệu":
    ...
    with st.container():
        ...
        with right_column:
            ...
            st.write("###")
            st.write("###")
            uunhuoc = Image.open("C:\\Users\\ADMIN\\Desktop\\package\\image\\uunhuoc.png")
...
#-------page 2 ------------------------------------------------------------------------------------------------------------------
#===================================================================================================================================
tourguide = Image.open("C:\\Users\\ADMIN\\Desktop\\package\\image\\tourguide.png")
vba = Image.open("C:\\Users\\ADMIN\\Desktop\\package\\image\\vba.png")
python = Image.open("C:\\Users\\ADMIN\\Desktop\\package\\image\\python.png")
guitar = Image.open("C:\\Users\\ADMIN\\Desktop\\package\\image\\guitar.png")
